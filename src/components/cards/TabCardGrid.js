...
const Input = tw.input`w-full block sm:inline-block px-6 py-4 rounded tracking-wider font-bold border border-secondary-600 focus:border-secondary-300 focus:outline-none sm:rounded-r-none hover:bg-primary-600 transition duration-300 text-black`
